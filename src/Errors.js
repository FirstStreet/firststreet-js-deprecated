export const RATE_LIMIT = 'Request rate limited. Free for non-commercial use for up to 10 requests per minute! To increase your rate limit, please contact api@floodiq.com';
...
export function normalizeError(messages = 'Unknown Client error', attachments = {***REMOVED***) {
  return {
    errors: true,
    messages,
    ...attachments,
